...
{
    // Add properties as required by the Lexoffice voucher API
...
[McpServerToolType]
public static class CreateVoucherTool
{
    [McpServerTool, Description("Creates a new Lexoffice voucher. Pass a CreateVoucherRequest object as input.")]
    public static async Task<string> CreateVoucherAsync(IServiceProvider serviceProvider, CreateVoucherRequest request)
    {
        ...
        var response = await client.PostAsync("vouchers", content);
