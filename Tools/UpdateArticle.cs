...
/// <summary>
/// Request model for updating a Lexoffice article.
/// </summary>
public class UpdateArticleRequest
{
    ...
    /// <summary>Description of the article (optional).</summary>
    public string? Description { get; set; }
    /// <summary>Global Trade Item Number (GTIN) of the article (optional).</summary>
    public string? Gtin { get; set; }
    /// <summary>Internal note for the article (optional).</summary>
    public string? Note { get; set; }
}

[McpServerToolType]
public static class UpdateArticleTool
{
    [McpServerTool, Description("Updates a Lexoffice article by its ID. Pass an UpdateArticleRequest object as input.")]
    public static async Task<string> UpdateArticleAsync(
        IServiceProvider serviceProvider,
        [Description("The article ID")] Guid articleId,
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var response = await client.PutAsync($"articles/{articleId}", content, cancellationToken);
        switch ((int)response.StatusCode)
        {
            ...
            case 404:
                throw new InvalidOperationException("Not Found: Requested article does not exist (anymore).");
            case 405:
